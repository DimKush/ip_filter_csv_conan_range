...
###  RANGE-V3
#################
set(CONAN_RANGE-V3_ROOT "/home/dim/.conan/data/range-v3/0.4.0/ericniebler/stable/package/c56f72666bd7a51587a21788921f73368560826e")
set(CONAN_INCLUDE_DIRS_RANGE-V3 "/home/dim/.conan/data/range-v3/0.4.0/ericniebler/stable/package/c56f72666bd7a51587a21788921f73368560826e/include")
set(CONAN_LIB_DIRS_RANGE-V3 "/home/dim/.conan/data/range-v3/0.4.0/ericniebler/stable/package/c56f72666bd7a51587a21788921f73368560826e/lib")
set(CONAN_BIN_DIRS_RANGE-V3 )
set(CONAN_RES_DIRS_RANGE-V3 )
set(CONAN_SRC_DIRS_RANGE-V3 )
set(CONAN_BUILD_DIRS_RANGE-V3 "/home/dim/.conan/data/range-v3/0.4.0/ericniebler/stable/package/c56f72666bd7a51587a21788921f73368560826e/")
...
# Apple Frameworks
conan_find_apple_frameworks(CONAN_FRAMEWORKS_FOUND_RANGE-V3 "${CONAN_FRAMEWORKS_RANGE-V3}")
...
set(CONAN_INCLUDE_DIRS "/home/dim/.conan/data/range-v3/0.4.0/ericniebler/stable/package/c56f72666bd7a51587a21788921f73368560826e/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/home/dim/.conan/data/range-v3/0.4.0/ericniebler/stable/package/c56f72666bd7a51587a21788921f73368560826e/lib" ${CONAN_LIB_DIRS})
...
set(CONAN_CMAKE_MODULE_PATH "/home/dim/.conan/data/range-v3/0.4.0/ericniebler/stable/package/c56f72666bd7a51587a21788921f73368560826e/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    set_property(TARGET CONAN_PKG::range-v3 PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_RANGE-V3} ${_CONAN_PKG_LIBS_RANGE-V3_DEPENDENCIES} ${CONAN_SHARED_LINKER_FLAGS_RANGE-V3_LIST} ${CONAN_EXE_LINKER_FLAGS_RANGE-V3_LIST}
                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_RANGE-V3_RELEASE} ${_CONAN_PKG_LIBS_RANGE-V3_DEPENDENCIES_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_RANGE-V3_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_RANGE-V3_RELEASE_LIST}>
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_RANGE-V3_RELWITHDEBINFO} ${_CONAN_PKG_LIBS_RANGE-V3_DEPENDENCIES_RELWITHDEBINFO} ${CONAN_SHARED_LINKER_FLAGS_RANGE-V3_RELWITHDEBINFO_LIST} ${CONAN_EXE_LINKER_FLAGS_RANGE-V3_RELWITHDEBINFO_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_RANGE-V3_MINSIZEREL} ${_CONAN_PKG_LIBS_RANGE-V3_DEPENDENCIES_MINSIZEREL} ${CONAN_SHARED_LINKER_FLAGS_RANGE-V3_MINSIZEREL_LIST} ${CONAN_EXE_LINKER_FLAGS_RANGE-V3_MINSIZEREL_LIST}>
                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_RANGE-V3_DEBUG} ${_CONAN_PKG_LIBS_RANGE-V3_DEPENDENCIES_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_RANGE-V3_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_RANGE-V3_DEBUG_LIST}>)
